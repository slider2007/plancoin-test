...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/.plancoincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.plancoind")
...
func NewInitApp(
	...
	app.planKeeper = plancoin.NewKeeper(
		app.cdc,
		app.accountKeeper,
		app.bankKeeper,
		app.structureKeeper,
